#ifndef CAFFE_MULTISTAGE_MEAN_FIELD_LAYER3D_HPP_
#define CAFFE_MULTISTAGE_MEAN_FIELD_LAYER3D_HPP_
...
template <typename Dtype>
class MultiStageMeanfield3DLayer : public Layer<Dtype> {

 public:
  explicit MultiStageMeanfield3DLayer(const LayerParameter& param) : Layer<Dtype>(param) {}
 ...
 protected:
  ...
  vector<shared_ptr<MeanfieldIteration3D<Dtype> > > meanfield_iterations_;
...
#endif //CAFFE_MULTISTAGE_MEAN_FIELD_LAYER3D_HPP_
