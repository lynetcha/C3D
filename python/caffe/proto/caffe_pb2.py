...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='propagate_down', full_name='caffe.LayerParameter.propagate_down', index=25,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='layer', full_name='caffe.LayerParameter.layer', index=26,
